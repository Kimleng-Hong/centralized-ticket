        ...
        <div class="col-md-10">
            ...
            <div class="content">
                <div class="head d-flex justify-content-between align-items-center mb-2">
                    <h4 class="m-0">Input Ticket Information</h4>
                </div>
                <div class="body">
                    <div class="row">
                        ...
                        @csrf
                            ...
                            <div class="mb-2">
                                ...
                                <div class="col-md-12">
                                    <input id="ticket_name" type="text" class="form form-control @error('ticket_name') is-invalid @enderror" name="ticket_name" value="{{ old('ticket_name') }}" autocomplete="ticket_name" required placeholder="Input the ticket name">
                                        @error('ticket_name')
